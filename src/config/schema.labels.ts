...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.music.spotify.enabled": "Enable Spotify Tool",
  "tools.music.spotify.redirectUri": "Spotify Redirect URI",
  "tools.music.spotify.market": "Spotify Market",
  "tools.music.spotify.defaultDeviceId": "Spotify Default Device ID",
  "tools.music.spotify.autoPlayOnOpen": "Spotify Auto Play On Open",
